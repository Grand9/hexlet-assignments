...
class ValidationTest {
    ...
    void testAdvancedValidate() throws IllegalAccessException {
        Address address1 = new Address("USA", "NY", "Broadway", "123", "desc");
        Map<String, List<String>> result1 = Validator.advancedValidate(address1);
        Map<String, List<String>> expected1 = Map.of();
        assertThat(result1).isEqualTo(expected1);

        Address address2 = new Address("USA", null, "Broadway", null, "desc");
